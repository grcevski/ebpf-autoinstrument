...
type bpf_tp_noloopConnectionInfoT struct {
	S_addr [16]uint8
	D_addr [16]uint8
	S_port uint16
	D_port uint16
...
type bpf_tp_noloopFramerFuncInvocationT struct {
	FramerPtr uint64
	Tp        bpf_tp_noloopTpInfoT
}

type bpf_tp_noloopGoroutineMetadata struct {
	Parent    uint64
	Timestamp uint64
}

type bpf_tp_noloopGrpcClientFuncInvocationT struct {
...
type bpf_tp_noloopGrpcSrvFuncInvocationT struct {
	StartMonotimeNs uint64
	Stream          uint64
	Tp              bpf_tp_noloopTpInfoT
}
...
// loadBpf_tp_noloop returns the embedded CollectionSpec for bpf_tp_noloop.
func loadBpf_tp_noloop() (*ebpf.CollectionSpec, error) {
	reader := bytes.NewReader(_Bpf_tp_noloopBytes)
	spec, err := ebpf.LoadCollectionSpecFromReader(reader)
	if err != nil {
		return nil, fmt.Errorf("can't load bpf_tp_noloop: %w", err)
	}

	return spec, err
}

// loadBpf_tp_noloopObjects loads bpf_tp_noloop and converts it into a struct.
//
// The following types are suitable as obj argument:
//
//	*bpf_tp_noloopObjects
//	*bpf_tp_noloopPrograms
//	*bpf_tp_noloopMaps
//
// See ebpf.CollectionSpec.LoadAndAssign documentation for details.
func loadBpf_tp_noloopObjects(obj interface{}, opts *ebpf.CollectionOptions) error {
	spec, err := loadBpf_tp_noloop()
	if err != nil {
		return err
	}
...
// bpf_tp_noloopSpecs contains maps and programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpf_tp_noloopSpecs struct {
	bpf_tp_noloopProgramSpecs
	bpf_tp_noloopMapSpecs
}

// bpf_tp_noloopSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type bpf_tp_noloopProgramSpecs struct {
...
// bpf_tp_noloopMapSpecs contains maps before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
type bpf_tp_noloopObjects struct {
	bpf_tp_noloopPrograms
	bpf_tp_noloopMaps
}

func (o *bpf_tp_noloopObjects) Close() error {
	return _Bpf_tp_noloopClose(
		&o.bpf_tp_noloopPrograms,
		&o.bpf_tp_noloopMaps,
	)
}

// bpf_tp_noloopMaps contains all maps after they have been loaded into the kernel.
//
// It can be passed to loadBpf_tp_noloopObjects or ebpf.CollectionSpec.LoadAndAssign.
...
// bpf_tp_noloopPrograms contains all programs after they have been loaded into the kernel.
//
// It can be passed to loadBpf_tp_noloopObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpf_tp_noloopPrograms struct {
...
func (p *bpf_tp_noloopPrograms) Close() error {
	return _Bpf_tp_noloopClose(
...
func _Bpf_tp_noloopClose(closers ...io.Closer) error {
...
//
//go:embed bpf_tp_noloop_bpfel_arm64.o
var _Bpf_tp_noloopBytes []byte
