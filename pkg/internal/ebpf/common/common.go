...
type GoKafkaClientInfo bpfKafkaClientReqT
...
const EventTypeGoKafka = 9          // Kafka client for Go
const EventTypeGoRedis = 10         // Redis client for Go
const EventTypeGPUKernelLaunch = 11 // GPU Kernel Launch
