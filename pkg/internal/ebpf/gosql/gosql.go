...
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -no-global-types -target amd64,arm64 bpf ../../../../bpf/go_sql.c -- -I../../../../bpf/headers -I../../../../bpf -I../../../../bpf/go
//go:generate $BPF2GO -cc $BPF_CLANG -cflags $BPF_CFLAGS -no-global-types -target amd64,arm64 bpf_debug ../../../../bpf/go_sql.c -- -I../../../../bpf/headers -I../../../../bpf -I../../../../bpf/go -DBPF_DEBUG
