...
static __always_inline void http_ServeHTTP_start(struct pt_regs *ctx) {
    bpf_dbg_printk("=== http uprobe/ServeHTTP === ");
...
static __always_inline void http_readRequest_end(struct pt_regs *ctx) {
    bpf_dbg_printk("=== http uprobe/proc readRequest returns === ");
...
static __always_inline int http_roundTrip_end(struct pt_regs *ctx) {
    bpf_dbg_printk("=== http uprobe/proc http roundTrip return === ");
...
#ifndef NO_HEADER_PROPAGATION
static __always_inline int http_writeSubset_start(struct pt_regs *ctx) {
    bpf_dbg_printk("=== http uprobe/proc header writeSubset === ");
...
static __always_inline void http2_http2RoundTrip_start(struct pt_regs *ctx) {
...
static __always_inline void http2_http2FramerWriteHeaders_start(struct pt_regs *ctx) {
...
static __always_inline int http2_http2FramerWriteHeaders_end(struct pt_regs *ctx) {
